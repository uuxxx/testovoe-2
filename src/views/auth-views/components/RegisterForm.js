...
import {
  showAuthMessage, showLoading, hideAuthMessage, authenticated,
...
export function RegisterForm(props) {
  const {
    showLoading, token, loading, redirect, message, showMessage, hideAuthMessage, authenticated, allowRedirect,
  } = props;
