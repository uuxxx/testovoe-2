...
export class UserList extends Component {	
	...
	openUserProfile(user) {
		const {email, name, website, username} = user
		this.props.setUser({email, name, website, username})
					...
					<div className="text-right">
						<Tooltip title="View">
							{/* <Link to={`${APP_PREFIX_PATH}/user-settings`}> */}
								<Button onClick={this.openUserProfile.bind(this, elm)} type="primary" className="mr-2" icon={<EyeOutlined />} size="small"></Button>
							{/* </Link> */}
						</Tooltip>
